    ...
    <React.Fragment>
      <div className="pt-20 pb-20">
        <div className="container grid grid-cols-1 p-3 mx-auto sm:w-full md:w-6/12">
          <div className="container p-4 mx-auto bg-gray-100 rounded-md shadow-md">
            ...
            <div className="flex flex-col items-center">
              <button
                ...
                className="object-center px-5 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue"
              >
                Tampilkan
              </button>
            </div>
