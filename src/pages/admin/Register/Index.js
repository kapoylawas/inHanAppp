          ...
          <div className="container grid grid-cols-1 p-3 mx-auto sm:w-full md:w-6/12">
            <div class="p-5 bg-red-50 rounded-md shadow-md">
              ...
              <form onSubmit={storeRegister}>
                ...
                <button
                  type="submit"
                  class="text-white mt-3 bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  {" "}
